    ...
    models = (
        {
            "model": SVC,
            "name": "SVM",
            "hyperparameters": {}, # No hyperparameter tuning as requested
            "scale": True,
        ...
        for feature_extraction in feature_extractions:
            ...
            for pca_dim in pcas:
                ...
                for model_config in models:
                    ...
                    # Apply scaling - SVM requires scaling for optimal performance
                    ...
                    print(f"Validation score: {val_score:.4f}, Training time: {training_time:.2f} seconds")
